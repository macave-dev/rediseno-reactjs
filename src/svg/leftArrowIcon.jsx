...
const LeftArrowIcon = ({state, props}) => { 
    const [id] = useState(uniqueId('left-arrow-'));
    return (
        <svg viewBox="0 0 14.965 27.796" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <clipPath className='arrow-left-icon'>
                    <rect transform="translate(0)" width="14.965" height="27.796" data-name="Rectángulo 99"/>
                </clipPath>
            </defs>
            <g transform="translate(0)" data-name="Grupo 107">
                <g clipPath={`url(.arrow-left-icon)`} data-name="Grupo 103" fill="currentColor">
